...
public class YoutubeStreamExtractor extends StreamExtractor {
    ...
    public YoutubeStreamExtractor(String pageUrl, Downloader dl, int serviceId)
            throws ExtractionException, IOException, JSONException {
        ...
        //this.pageUrl = "https://www.youtube.com/watch?v=FzRH3iTQPrk";
    ...
    public List<VideoStream> getVideoStreams() throws ParsingException {
        ...
        try{
            ...
            String formatedUrls = "";
            Vector<StreamPreviewInfo> relatedVideosList = this.getRelatedVideos();

            for( i =1; i<=5; i++) {
                listOfUrls.add(relatedVideosList.get(i).webpage_url);
            }
            formatedUrls = geturls(listOfUrls);
    ...
    public  String geturls (ArrayList<String> urls) throws ParsingException, IOException, JSONException {
        ...
        String pageContent = downloader.download(urlidhandler.cleanUrl(urls.get(i)));
        doc = Jsoup.parse(pageContent, urls.get(i));
        ytPlayerConfig = getPlayerConfig(pageContent);
        playerArgs = getPlayerArgs(ytPlayerConfig);
        playerUrl = getPlayerUrl(ytPlayerConfig);
