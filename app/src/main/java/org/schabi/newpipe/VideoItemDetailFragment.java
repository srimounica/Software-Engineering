...
public class VideoItemDetailFragment extends Fragment {
    ...
    private void updateInfo(final StreamInfo info) {
        try {
            ...
            Log.d("Auto Play", String.valueOf(autoPlayEnabled));
            ...
            similarView.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_UP) {
                        ...
                        Log.d("Similar Videos URL", item.webpage_url);
                        detailIntent.putExtra(
...
/*        //////TEST
        ...
        if (PreferenceManager.getDefaultSharedPreferences(activity)
            ...
            if (PreferenceManager.getDefaultSharedPreferences(activity)
                ...
                SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(getContext());
                SharedPreferences.Editor prefEditor = sp.edit();
                prefEditor.putString("LISTOFURLS",selectedVideoStream.urls);
                prefEditor.commit();
